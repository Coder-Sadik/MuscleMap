      ...
      <div className="z-10 w-full max-w-[400px] px-6 py-12 animate-in fade-in zoom-in-95 duration-700 ease-out">
        ...
        <div className="text-center mb-10 space-y-2">
          <h1 className="text-3xl font-extrabold tracking-tight text-white">
            Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">Crush It?</span>
          </h1>
          <p className="text-sm text-zinc-400 font-medium">
            Sign in to access your personalized plans.
          </p>
        </div>
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs font-medium text-emerald-500 hover:text-emerald-400 hover:underline transition-colors">
                  Forgot?
                </Link>
              </div>
              <Input
        ...
        <div className="mt-8 text-center">
          <p className="text-sm font-medium text-zinc-500">
            ...
            <Link href="/signup" className="text-white hover:text-emerald-400 hover:underline transition-colors">
              Start your journey
            </Link>
          </p>
        </div>
